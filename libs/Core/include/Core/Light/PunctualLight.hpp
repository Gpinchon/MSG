...
// Includes
////////////////////////////////////////////////////////////////////////////////
#include <Core/Light/ShadowCaster.hpp>
...
struct LightBase {
    ...
    Core::ShadowSettings shadowSettings;
};
...
struct LightIBL : LightBase {
    ...
    LightIBL(const glm::ivec2& a_Size, const std::shared_ptr<Core::Texture>& a_Skybox);
    /// @brief Creates an IBL light from a skybox, generating the prefiltered specular map
    LightIBL(const glm::ivec2& a_Size, const std::shared_ptr<Core::Cubemap>& a_Skybox);
    /// @brief the prefiltered specular map
    Core::TextureSampler specular;
