...
public:
    ...
    bool Intersects(const Cube& a_Other);
    bool Contains(const Cube& a_Other);
    bool Contains(const glm::vec3& a_Position, const glm::mat4x4& a_TransformMatrix = { 1.f }) const;
