...
| [uri](#uri)   | `string` | Required | cannot be null | [MSGAssets-external](external-definitions-external-properties-uri.md "external.schema.json#/definitions/external/properties/uri")   |
