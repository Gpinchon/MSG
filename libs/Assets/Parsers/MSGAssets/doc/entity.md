...
| :--------------------- | :--------- | :------------- | :---------------------- | :---------------- | :-------------------- | :------------------ | :------------------------------------------------------------------------ |
| Cannot be instantiated | Yes        | Unknown status | Unknown identifiability | Forbidden         | Allowed               | none                | [entity.schema.json](json/defs/entity.schema.json "open original schema") |

## MSGAssets-entity Type

`object` ([MSGAssets-entity](entity.md))

# MSGAssets-entity Definitions
