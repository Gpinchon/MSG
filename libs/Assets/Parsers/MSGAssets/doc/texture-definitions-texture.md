...
```txt
texture.schema.json#/definitions/texture
```

a texture is a set of images each describing a mipmap level
...
| [type](#type)               | `string`  | Optional | cannot be null | [MSGAssets-texture](texture-definitions-texturetype.md "texture.schema.json#/definitions/texture/properties/type")                         |
...
* defined in: [MSGAssets-texture](texture-definitions-texturetype.md "texture.schema.json#/definitions/texture/properties/type")
