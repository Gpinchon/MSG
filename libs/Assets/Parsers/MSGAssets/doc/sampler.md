...
| :--------------------- | :--------- | :------------- | :---------------------- | :---------------- | :-------------------- | :------------------ | :-------------------------------------------------------------------------- |
| Cannot be instantiated | Yes        | Unknown status | Unknown identifiability | Forbidden         | Allowed               | none                | [sampler.schema.json](json/defs/sampler.schema.json "open original schema") |

## MSGAssets-sampler Type

`object` ([MSGAssets-sampler](sampler.md))

# MSGAssets-sampler Definitions

## Definitions group samplerFilter
...
## Definitions group samplerCompareMode
...
## Definitions group samplerCompareFunc
...
```json
{"$ref":"sampler.schema.json#/definitions/sampler"}
```

| Property                        | Type     | Required | Nullable       | Defined by                                                                                                                                       |
| :------------------------------ | :------- | :------- | :------------- | :----------------------------------------------------------------------------------------------------------------------------------------------- |
| [magFilter](#magfilter)         | `string` | Optional | cannot be null | [MSGAssets-sampler](sampler-definitions-sampler-properties-magfilter.md "sampler.schema.json#/definitions/sampler/properties/magFilter")         |
| [minFilter](#minfilter)         | `string` | Optional | cannot be null | [MSGAssets-sampler](sampler-definitions-sampler-properties-minfilter.md "sampler.schema.json#/definitions/sampler/properties/minFilter")         |
...
| [compareMode](#comparemode)     | `string` | Optional | cannot be null | [MSGAssets-sampler](sampler-definitions-sampler-properties-comparemode.md "sampler.schema.json#/definitions/sampler/properties/compareMode")     |
| [compareFunc](#comparefunc)     | `string` | Optional | cannot be null | [MSGAssets-sampler](sampler-definitions-sampler-properties-comparefunc.md "sampler.schema.json#/definitions/sampler/properties/compareFunc")     |
...
* defined in: [MSGAssets-sampler](sampler-definitions-sampler-properties-magfilter.md "sampler.schema.json#/definitions/sampler/properties/magFilter")
...
* defined in: [MSGAssets-sampler](sampler-definitions-sampler-properties-minfilter.md "sampler.schema.json#/definitions/sampler/properties/minFilter")
...
* defined in: [MSGAssets-sampler](sampler-definitions-sampler-properties-comparemode.md "sampler.schema.json#/definitions/sampler/properties/compareMode")
...
* defined in: [MSGAssets-sampler](sampler-definitions-sampler-properties-comparefunc.md "sampler.schema.json#/definitions/sampler/properties/compareFunc")
