...
| Property          | Type     | Required | Nullable       | Defined by                                                                                                                            |
| :---------------- | :------- | :------- | :------------- | :------------------------------------------------------------------------------------------------------------------------------------ |
| [uri](#uri-1)     | `string` | Optional | cannot be null | [MSGAssets-buffer](buffer-definitions-bufferview-properties-uri.md "buffer.schema.json#/definitions/bufferView/properties/uri")       |
| [name](#name-1)   | `string` | Optional | cannot be null | [MSGAssets-buffer](buffer-definitions-bufferview-properties-name.md "buffer.schema.json#/definitions/bufferView/properties/name")     |
