...
MSG::Renderer::DfdFog::DfdFog(Renderer::Impl& a_Renderer)
    : RenderPassInterface({ typeid(DfdOpaqueGeometry), typeid(DfdLight), typeid(DfdSSAO) })
{
}

void MSG::Renderer::DfdFog::Update(Renderer::Impl& a_Renderer, const RenderPassesLibrary& a_RenderPasses)
{
...
void MSG::Renderer::DfdFog::Render(Impl& a_Renderer)
{
