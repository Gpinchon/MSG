...
MSG::Renderer::DfdSubPassOpaqueGeometry::DfdSubPassOpaqueGeometry()
    : RenderSubPassInterface(/* NO DEPENDENCIES */)
{
}

void MSG::Renderer::DfdSubPassOpaqueGeometry::Update(Renderer::Impl& a_Renderer, RenderPassInterface* a_ParentPass)
{
}

void MSG::Renderer::DfdSubPassOpaqueGeometry::Render(Impl& a_Renderer)
{
