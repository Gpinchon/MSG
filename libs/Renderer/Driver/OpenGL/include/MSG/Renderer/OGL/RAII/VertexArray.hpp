...
#include <MSG/Renderer/OGL/IndexDescription.hpp>
#include <MSG/Renderer/OGL/VertexAttributeDescription.hpp>
#include <MSG/Renderer/OGL/VertexBindingDescription.hpp>
